...
<body>
   <a href="<?php echo base_url() . 'index.php/Tables' ?>"> <div class="innercircle" id="innercircle">
    ...
    <div id="curved1" class="text2" style="bottom: 39vh;
  height: 1.80761em;
  position: fixed;
  left: 0px;
  right: 0px;
  ...
  margin: auto;">
    ...
    <a class="anchor1" style="color: black;" href="<?php echo base_url() . 'index.php/inventory' ?>">INVENTORY</a>
        
    </div>
    <div class="text2" id="curved2" style=" bottom: 0px;
    /* position: relative; */
    height: 1.80761em;
    position: fixed;
    left: 0px;
    ...
    <a class="anchor2" style="color: black;" href="<?php echo base_url() . 'index.php/reports' ?>">REPORTS</a>
        
    </div>
    <div class="text1">
        <h6><a class="anchor3" style="color: black; text-decoration: none;" href="<?php echo base_url() . 'index.php/Dompdf_controller' ?>">INVOICES</a></h6>

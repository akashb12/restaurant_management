                ...
                <div class="right-border">
                    <div class="col-md-12">
                        <h1>
                            ...
                            <div class="float-right mr-4 mt-3"><a style="background: #ec9a29;" href="javascript:void(0);" class="btn btn-success" data-toggle="modal" data-target="#Modal_Add"><span class="fa fa-plus"></span> Add New</a></div>
                        </h1>
                    </div>
                </div>

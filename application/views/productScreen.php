            ...
            <div class="col-md-9 no-gutters" id="overlay">
                <div class="left-side">
                    ...
                    <div style="text-align: center; padding-top: 10px; ">
                        <h3 style="color: white;"><b>Add Product</b></h3>
                    </div>
                    <div id="editForm">
                        <form action="" method="post" id="form" enctype="multipart/form-data">
                            <div class="row form">
                                <div class="col-md-4" style="background:white; display: flex; align-items: center; justify-content: center;">
                            ...
                            <div class="row">
                                ...
                                <div class=" buttons col-md-2">
                                    <button name="submit" type="submit" class="btn"> <span><i class="fa fa-plus" aria-hidden="true"></i></span>&nbsp;Add Products</button>
